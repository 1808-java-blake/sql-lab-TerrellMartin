...
//all primitives start with lower case letters while all classes and packages start with upper case.

//you generate getter and setters with: ALT + SHIFT + S
...
public class RollerCoaster {
	...
	public String toString() {
		return "RollerCoaster [numberCarts=" + numberCarts + ", rating=" + rating + ", maxCapacity=" + maxCapacity
				+ ", name=" + name + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
