...
public class Game {
	...
	//Fourth encounter: West way
	public void ignoreOldMan() {
		position = "ignoreOldMan";
		mainTextArea.setText("You ignored the old man. You continue to walk westward. You see a bright shiny light. What do you want to do..? ");		
		choice1.setText("Inspect");
		choice2.setText("Leave");
		choice3.setText("..");
		choice4.setText("..");
	}
	public void questionOldMan() {
		position = "questionOldMan";
		mainTextArea.setText("You ask, 'Hey, why are you out here all alone? The Old man turns around, but you quickly find out the old man isnt actually an old man. Creature: 'ARRRGHHHHH, FACE ME!!'");		
		choice1.setText("Fight");
		choice2.setText("Run");
		choice3.setText("Insult");
		choice4.setText("..");
	}
	public void stealFromOldMan() {
		position = "stealFromOldMan";
		mainTextArea.setText("You steal 10 gold from the old man. He turns around, but you realizes this isnt an old man after all. Create: 'ARRGGGHHH, FACE ME'");		
		choice1.setText("Fight");
		choice2.setText("Run");
		choice3.setText("Insult");
		choice4.setText("..");
